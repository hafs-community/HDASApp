...
###### USER INPUT #####
YOUR_PATH_TO_HDASAPP="/scratch3/NCEPDEV/hwrf/save/Jing.Cheng/JEDI/HDASApp"
YOUR_EXPERIMENT_DIR="/scratch3/HFIP/hwrfv3/scrub/Jing.Cheng/jediwork"
YOUR_PATH_TO_GSI="/scratch3/NCEPDEV/hwrf/save/Jing.Cheng/GSIversions/GSI"
...
if [[ ! ( $MACHINE_ID == "hera" || $MACHINE_ID == "ursa" || $MACHINE_ID == "orion" || $MACHINE_ID == "hercules" ) ]]; then
   echo "Not a valid MACHINE_ID: ${MACHINE_ID}. Please use hera | ursa | orion | hercules."
   exit 3
fi
case ${MACHINE_ID} in
   hera)
      DATA_STAGE="/scratch2/NCEPDEV/hwrf/save/Jing.Cheng/JEDI/staged-data"
   ;;
   ursa)
